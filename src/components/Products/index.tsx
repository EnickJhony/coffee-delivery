import { Cart, CoffeeActions, CoffeeCard, CoffeeDescription, CoffeeList, CoffeePrice, CoffeeTag, CoffeeTitle, CoffeeValue, Counter, Currency, OursCoffee, Price } from "./styles";
